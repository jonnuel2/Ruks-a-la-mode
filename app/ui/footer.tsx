...
<div className="mb-4">
  <p className="font-semibold opacity-90 mb-2 text-sm lg:text-base">General Support</p>
...
<div>
  <p className="font-semibold opacity-90 mb-2 text-sm lg:text-base">Wholesale / Partnerships</p>
  <div className="flex items-center space-x-2">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
